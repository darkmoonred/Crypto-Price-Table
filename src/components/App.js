  ...
  getData = () => {
    ...
    axios({
      ...
      "headers": {
        ...
        "x-rapidapi-key": "2321107740msh8cc921f24a259a8p196c4fjsnb8d98cb95288",
        "useQueryString": true
      }
    })
      .then((response) => {
      ...
      <div>
        <nav className="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow text-monospace text-white">
          <a
            ...
            href="https://www.github.com/gregrossc"
            target="_blank"
          ...
          {this.state.loading ? <div id="loader" className="nav-item text-nowrap d-none d-sm-none d-sm-block"></div> :
